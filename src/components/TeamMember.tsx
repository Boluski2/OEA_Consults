...
const TeamMember: React.FC<TeamMemberProps> = ({ 
  ...
  return (
    <div
      ref={cardRef}
      className={cn(
        "glass-card rounded-xl overflow-hidden animate-on-scroll transition-all duration-500 hover:shadow-xl"
      )}
          ...
          <div className="absolute top-4 right-4 flex space-x-2">
            {socialLinks.email && (
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center backdrop-blur-sm hover:bg-oea-blue/80 transition-colors"
              >
